...
public class World {
    ...
    static class 鸟 extends 动物模板 implements 会叫的东西,会飞的东西{
    ...
    static abstract class 会叫的动物 extends 动物模板 implements 会叫的东西{
        abstract public void 叫();
    }

    static abstract class 会飞的动物 extends 动物模板 implements 会飞的东西{
        abstract public void 飞();
    }

    static class 动物模板 implements 动物{
        public void 新陈代谢() {
