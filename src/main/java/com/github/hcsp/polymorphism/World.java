...
public class World {
    ...
    static abstract class animal implements 动物 {
        public void 新陈代谢() {
            System.out.println("新陈代谢");
        }
    }

    static abstract class 抽象鸟 extends animal implements 会叫的东西, 会飞的东西 {
        public void 叫() {
    ...
    static class 麻雀 extends 抽象鸟 {

    }

    static class 喜鹊 extends 抽象鸟 {
