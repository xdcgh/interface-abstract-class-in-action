...
public class World {
    ...
    static class 麻雀 extends 鸟 implements 会叫的东西,会飞的东西{
    }

    static class 喜鹊 extends 鸟 implements 会叫的东西,会飞的东西{
    }
    ...
    static class 鸟 implements 动物,会飞的东西,会叫的东西{
        public void 飞() {
    ...
    interface 动物 {
        default void 新陈代谢(){ System.out.println("新陈代谢");};
    }
