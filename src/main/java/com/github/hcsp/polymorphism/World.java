...
public class World {
    ...
    public static void 动物都能新陈代谢() {
        for (Object obj : objects) {
            if (obj instanceof 有新陈代谢的动物) {
                ((动物) obj).新陈代谢();
            }
        }
    }

    static class 有新陈代谢的动物 implements 动物 {
        public void 新陈代谢() {
            System.out.println("新陈代谢");
        }
    }

    static class 会飞会叫的鸟 extends 有新陈代谢的动物 implements 会飞的东西,会叫的东西{
        public void 飞() {
    ...
    static class 麻雀 extends 会飞会叫的鸟 {
    }

    static class 喜鹊 extends 会飞会叫的鸟 {
    }

    static class 蝴蝶 extends 有新陈代谢的动物 implements 会飞的东西{
        public void 飞() {
    ...
    static class 猫 extends 有新陈代谢的动物 implements 会叫的东西{
    ...
    static class 狗 extends 有新陈代谢的动物 implements 会叫的东西{
