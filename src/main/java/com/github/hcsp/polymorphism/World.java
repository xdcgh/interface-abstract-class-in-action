...
public class World {
    ...
    static class LiveAnimal implements 动物 {
        @Override
        public void 新陈代谢() {
    ...
    static class Bird extends LiveAnimal implements 会飞的东西, 会叫的东西 {
        @Override
        public void 飞() {
    ...
    static class 蝴蝶 extends LiveAnimal implements 会飞的东西 {
        public void 飞() {
    ...
    static class 猫 extends LiveAnimal implements 会叫的东西 {
    ...
    static class 狗 extends LiveAnimal implements 会叫的东西 {
