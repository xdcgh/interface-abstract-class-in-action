...
public class World {
    ...
    static class 麻雀 extends AbstractBird implements 会叫的东西 {
        public void 叫() {
            System.out.println("叽叽喳喳");
        }
    }

    static class 喜鹊 extends AbstractBird implements 会叫的东西 {
        public void 叫() {
            System.out.println("叽叽喳喳");
        }
    }

    static class 蝴蝶 extends AbstractBird {
        @Override
        public void 飞() {
    ...
    static abstract class AbstractBird extends AbstractAnimal implements 会飞的东西 {
        public void 飞() {
