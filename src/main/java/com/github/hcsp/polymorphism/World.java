...
public abstract class World {
    ...
    static class 生物 implements 动物{
        @Override
        public void 新陈代谢(){
            System.out.println("新陈代谢");
        }
    }
    static class 鸟 extends 生物 implements 会飞的东西,会叫的东西{
        @Override
        public void 飞(){
    ...
    static class 蝴蝶 extends 生物 implements 会飞的东西{
        @Override
        public void 飞() {
    ...
    static class 猫 extends 生物 implements 会叫的东西{
        @Override
        public void 叫() {
    ...
    static class 狗 extends 生物 implements 会叫的东西{
        @Override
        public void 叫() {
