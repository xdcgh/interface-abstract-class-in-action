...
public class World {
    ...
    static class LivingAnimals implements 动物 {
        public void 新陈代谢() {
            System.out.println("新陈代谢");
        }
    }

    static class bird extends LivingAnimals implements 会飞的东西, 会叫的东西 {
        public void 飞() {
    ...
    static class 蝴蝶 extends LivingAnimals implements 会飞的东西 {
        public void 飞() {
    ...
    static class 猫 extends LivingAnimals implements 会叫的东西 {
        public void 叫() {
            System.out.println("喵喵喵");
        }
    }

    static class 狗 extends LivingAnimals implements 会叫的东西 {
        public void 叫() {
