...
public class World {
    ...
    static class 蝴蝶 extends livedAnimal implements 会飞的东西{
        @Override
        public void 飞() {
    ...
    static class 猫 extends livedAnimal implements 会叫的东西{
        @Override
        public void 叫() {
    ...
    static class 狗 extends livedAnimal implements 会叫的东西{
        @Override
        public void 叫() {
