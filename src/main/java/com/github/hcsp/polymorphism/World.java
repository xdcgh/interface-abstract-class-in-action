...
public class World {
    ...
    static abstract class abstract动物 implements 动物{
        public void 新陈代谢() {
            System.out.println("新陈代谢");
        }
    }

    static abstract class 会飞的动物 extends abstract动物 implements 会飞的东西{
        public abstract void 飞();

    }
    static abstract class 会叫的动物 extends abstract动物 implements  会叫的东西{
        public abstract void 叫();
    }

    static class 鸟 extends 会飞的动物 implements 会叫的东西{
        public void 飞() {
